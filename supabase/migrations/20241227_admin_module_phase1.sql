...
DROP POLICY IF EXISTS "Admins podem ver todos profissionais" ON fitness_professionals;
DROP POLICY IF EXISTS "Profissionais podem ver seu registro" ON fitness_professionals;
DROP POLICY IF EXISTS "Admins podem criar profissionais" ON fitness_professionals;
DROP POLICY IF EXISTS "Admins podem atualizar profissionais" ON fitness_professionals;
DROP POLICY IF EXISTS "Profissionais podem atualizar seu registro" ON fitness_professionals;
...
-- Remover políticas existentes antes de criar
DROP POLICY IF EXISTS "Admins podem ver todas atribuições" ON fitness_client_assignments;
DROP POLICY IF EXISTS "Profissionais podem ver suas atribuições" ON fitness_client_assignments;
DROP POLICY IF EXISTS "Clientes podem ver suas atribuições" ON fitness_client_assignments;
DROP POLICY IF EXISTS "Admins podem criar atribuições" ON fitness_client_assignments;
DROP POLICY IF EXISTS "Admins podem atualizar atribuições" ON fitness_client_assignments;
DROP POLICY IF EXISTS "Admins podem deletar atribuições" ON fitness_client_assignments;
...
-- Remover políticas existentes antes de criar
DROP POLICY IF EXISTS "Usuários podem ver seus aceites" ON fitness_terms_acceptance;
DROP POLICY IF EXISTS "Usuários podem criar aceites" ON fitness_terms_acceptance;
DROP POLICY IF EXISTS "Admins podem ver todos aceites" ON fitness_terms_acceptance;
...
-- Remover políticas existentes antes de criar
DROP POLICY IF EXISTS "Admins podem ver todo uso de API" ON fitness_api_usage;
...
-- Remover políticas existentes antes de criar
DROP POLICY IF EXISTS "Admins podem ver logs de auditoria" ON fitness_audit_log;
