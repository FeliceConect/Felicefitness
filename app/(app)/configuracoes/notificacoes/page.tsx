  ...
  return (
    <div className="min-h-screen bg-[#0A0A0F] pb-32">
      ...
      <div className="px-4 space-y-6">
        ...
        {/* Info */}
        <section className="bg-[#14141F] border border-[#2E2E3E] rounded-xl p-4">
          <h3 className="text-white font-medium mb-2">Sobre as Notificações</h3>
      ...
      {hasChanges && isSubscribed && (
        <div className="fixed bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-[#0A0A0F] via-[#0A0A0F] to-transparent">
          <motion.button
            ...
            onClick={handleSave}
            disabled={isSaving}
            className="w-full py-4 bg-gradient-to-r from-violet-600 to-cyan-500 text-white rounded-xl font-semibold flex items-center justify-center gap-2"
          >
            {isSaving ? (
              <>
